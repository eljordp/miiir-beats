...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[85vh] sm:min-h-[85vh] flex flex-col justify-center overflow-hidden pt-14 sm:pt-16">
      {/* Background */}
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 sm:gap-12 mb-8 sm:mb-14">
          <div className="max-w-md animate-fade-up delay-300">
            ...
            <div className="flex gap-3">
              <a
                href="#beats"
                className="flex-1 sm:flex-none px-6 py-3 bg-accent text-background font-bold rounded-sm hover:bg-accent-dim active:scale-[0.98] transition-all text-sm uppercase tracking-wider text-center"
              >
                Browse Beats
              </a>
              <a
          ...
          {/* Stats — grid on mobile so they don't squish */}
          <div className="grid grid-cols-3 sm:flex sm:flex-col gap-2 sm:gap-4 sm:text-right animate-fade-up delay-400">
            <div>
              <p className="text-xl xs:text-2xl sm:text-3xl font-bold text-accent tabular-nums">{streams}M+</p>
              <p className="text-[9px] xs:text-[10px] text-muted uppercase tracking-wider">Streams</p>
            </div>
            <div>
              <p className="text-xl xs:text-2xl sm:text-3xl font-bold tabular-nums">{placements}+</p>
              <p className="text-[9px] xs:text-[10px] text-muted uppercase tracking-wider">Placements</p>
            </div>
            <div>
              <p className="text-xl xs:text-2xl sm:text-3xl font-bold tabular-nums">{views}M+</p>
              <p className="text-[9px] xs:text-[10px] text-muted uppercase tracking-wider">Views</p>
            </div>
          </div>
        </div>
      </div>
