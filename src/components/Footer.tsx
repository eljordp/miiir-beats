        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted leading-relaxed">
              ...
              Bay Area. 107M+ streams.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted mb-4">
              Connect
            </h4>
          ...
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted mb-4 leading-relaxed">
              Need a custom beat or exclusive production? DM for collabs and custom orders.
            </p>
            <a
              href="https://www.instagram.com/415miiir/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex px-5 py-2.5 sm:py-2 bg-accent text-background text-xs sm:text-sm font-bold uppercase tracking-wider hover:bg-accent-dim active:scale-[0.98] transition-all"
            >
              DM on Instagram
            </a>
          </div>
